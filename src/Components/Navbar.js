...
export default function kaliya(prop) {
  return (
    <nav
    ...
    >
      <div className="container-fluid">
        ...
        <div className={`form-check form-switch mx-3 text-${prop.text}`}>

  <input className="form-check-input" type="checkbox" onClick={prop.toggleMode} role="switch" id="flexSwitchCheckDefault"/>
  <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{prop.para}</label>
</div>
      </div>
    </nav>
  );
